...
// The chip select pin 
#define GLCD_CS1     LATC0
// The reset pin (this is required and should not be tied high) 
#define GLCD_RESET   LATC1
// The A0 pin, which selects command or data mode 
#define GLCD_A0      LATC2
// The clock pin 
#define GLCD_SCL     LATC3
// The data pin 
#define GLCD_SDA     LATC4
...
#define GLCD_CMD_DISPLAY_ON 		0b10101111  // 0xAF
// Command: turn the display off 
#define GLCD_CMD_DISPLAY_OFF 		0b10101110  // 0xAE

// Command: set all points on the screen to normal. 
#define GLCD_CMD_ALL_NORMAL			0b10100100  // 0xA4
// Command: set all points on the screen to "on", without affecting 
//           the internal screen buffer. 
#define GLCD_CMD_ALL_ON				0b10100101  // 0xA5

// Command: disable inverse (black pixels on a white background) 
#define GLCD_CMD_DISPLAY_NORMAL		0b10100110  // 0xA6
// Command: inverse the screen (white pixels on a black background) 
#define GLCD_CMD_DISPLAY_REVERSE	0b10100111  // 0xA7

// Command: set LCD bias to 1/9th 
#define GLCD_CMD_BIAS_9				0b10100010  // 0xA2
// Command: set LCD bias to 1/7th 
#define GLCD_CMD_BIAS_7				0b10100011  // 0xA3

// Command: set ADC output direction to normal. 
#define GLCD_CMD_HORIZONTAL_NORMAL	0b10100000  // 0xA0
...
#define GLCD_CMD_HORIZONTAL_REVERSE	0b10100001  // 0xA1

// Command: set common output scan direction to normal. 
#define GLCD_CMD_VERTICAL_NORMAL	0b11000000  // 0xC0
// Command: set common output scan direction to reversed (vertically flipped). 
#define GLCD_CMD_VERTICAL_REVERSE	0b11001000  // 0xC8

// Command: select the internal power supply operating mode. 
#define GLCD_CMD_POWER_CONTROL		0b00101000  // 0x28

// Command: set internal R1/R2 resistor bias (OR with 0..7) 
#define GLCD_CMD_RESISTOR			0b00100000  // 0x20
